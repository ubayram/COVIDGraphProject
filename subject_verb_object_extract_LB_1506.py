...
path_to_stopwords = '/Users/mac/Documents/GitHub/COVIDGraphProject/nltk_stopwords.txt'
...
#         lefts = [tok for tok in prep.lefts if tok.pos_ == 'NOUN']
    ...
    return [(s,o) for (s,o) in list_res if (s !='') and (o !='') and (s != o)]
